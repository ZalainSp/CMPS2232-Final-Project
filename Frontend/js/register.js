document.addEventListener("DOMContentLoaded", () => {
  ...
  tabs.forEach((tab) => {
    tab.addEventListener("click", () => {
      ...
      document.getElementById("field-address").style.display =
        role === "Customer" ? "block" : "none";
      document.getElementById("field-manager").style.display =
        role === "Manager" ? "block" : "none";
      document.getElementById("field-driver").style.display =
